...
export const StudyingTouristColumns = {
  columns: [
    {
    ...
    {
      accessorKey: "universityNameHebrew",
      header: "Nom de l'université (hébreu)",
    },
    {
      accessorKey: "diplomaNameHebrew",
      header: "Nom du diplôme (hébreu)",
    },
    {
